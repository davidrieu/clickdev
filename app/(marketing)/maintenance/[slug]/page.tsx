...
import { maintenanceNavSilo } from "@/lib/constants/navigation";
import { findChildBySlug, siloChildStaticParams } from "@/lib/navigation/silo-child-utils";

const SILO = maintenanceNavSilo;
...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      ...
      `Clickdev — maintenance & TMA : ${child.label.toLowerCase()}.`,
  };
}

export default async function MaintenanceChildPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
