...
export function DevisIndexFaq({ items }: Props) {
      ...
      <div className="relative z-10 mx-auto max-w-[760px] px-4 md:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm text-white/55 md:text-base">
            Ce qui revient souvent : lecture humaine, niveau de détail attendu, confidentialité, et clarté quand
            l&apos;offre ne colle pas — sans tourner en rond.
          </p>
        </motion.div>
