...
export function DevisPremiumHero() {
        ...
        <div className="flex flex-col justify-center md:col-span-6 md:py-4 lg:py-6">
          ...
          >
            ...
            <p className="font-mono text-[10px] tracking-[0.22em] text-white/45 uppercase md:text-[11px] md:tracking-[0.24em]">
              David Rieu — développeur web freelance
            </p>
          </motion.div>
          ...
          >
            Un devis utile, c&apos;est déjà <em className="text-white/80 italic">cadrer</em> l&apos;échange.
          </motion.h1>
          ...
          >
            Même pédigrée que le pilier Sites internet : mêmes principes, même exigence sur le fond. Dites
            l&apos;essentiel ici, je reviens vers vous avec un retour structuré (ou des questions) sous 24 à
            48 h ouvrées.
          </motion.p>
          ...
          >
            ...
            >
              <span className="relative z-10">Offres sites internet</span>
            </Link>
          </motion.div>
        </div>
